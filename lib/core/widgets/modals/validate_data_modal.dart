...
void showValidateDataModal(BuildContext context) {
          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Untuk melanjutkan laporan, anda diwajibkan untuk melengkapi data diri terlebih dahulu. Silahkan klik tombol Lengkapi dibawah untuk melanjutkan proses laporan.',
                  style: TextStyle(
                    fontSize: AppFontSize.bodyMedium,
